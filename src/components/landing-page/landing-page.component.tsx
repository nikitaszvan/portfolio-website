...
import { CollapseAndFade } from '../css-animation/css-animation.component';
  ...
  return (
    <Container>
        ...
        <OverlayContainer>
          ...
          <MainNavBar/>
          <TextContainer>
            <CollapseAndFade in={isOpen} collapsedSize="0px">
            ...
            <p>& I'm a front-end developer based in Toronto, Canada 🇨🇦</p>
            <AnimatedButton>
              Check me out
            </AnimatedButton>
            </TextContainer>
